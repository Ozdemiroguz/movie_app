...
class $AssetsLottieGen {
  ...
  /// File path: assets/lottie/Loading Animation Bored Hand.json
  String get loadingAnimationBoredHand =>
      'assets/lottie/Loading Animation Bored Hand.json';
  ...
  /// List of all assets
  List<String> get values => [loadingAnimationBoredHand, loading, notFound];
}
